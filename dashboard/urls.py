...
urlpatterns = [
    path('', staff_member_required(views.dashboard, login_url='login'), name='dashboard'),
    path('categories/', staff_member_required(views.categories, login_url='login'), name='dashboard-categories'),
    path('category/<slug:slug>', staff_member_required(views.category_details, login_url='login'), name='dashboard-category-details'),
    path('add-category', staff_member_required(views.add_category, login_url='login'), name='dashboard-add-category'),
    path('category/edit-category/<int:pk>', staff_member_required(views.update_category, login_url='login'), name='dashboard-update-category'),
    path('category/delete-category/<int:pk>', staff_member_required(views.delete_category, login_url='login'), name='dashboard-delete-category'),


    path('products/', staff_member_required(views.products, login_url='login'), name='dashboard-products'),
    path('product/<slug:slug>/', staff_member_required(views.product_details, login_url='login'), name='dashboard-product-details'),
    path('add-product/', staff_member_required(views.add_product, login_url='login'), name='dashboard-add-product'),
    path('product/edit-product/<int:pk>', staff_member_required(views.update_product, login_url='login'), name='dashboard-update-product'),
    path('product/delete-product/<int:pk>', staff_member_required(views.delete_product, login_url='login'), name='dashboard-delete-product'),


    path('orders/', staff_member_required(views.dashboard_orders), name='dashboard-orders'),
    path('order-details/<uuid:uid>/', staff_member_required(views.dashboard_order_details), name='dashboard-order-details'),
